	...
	return (
		<>
			<div className='m-10 flex flex-row justify-center border-2 rounded-3xl'>
				<img className='max-h-screen rounded-3xl basis-1/3 w-full h-auto' src={film.image}></img>
				<div className='basis-2/3'>
					<div className='p-8'>
						<h1 className='text-5xl'>
							{film.title}
						</h1>
                        <p className='m-2'>{film.original_title} &#40;<span className='italic'>{film.original_title_romanised}</span>&#41;</p>
					</div>
